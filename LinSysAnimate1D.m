function [MovAnim,zlims] = LinSysAnimate1D(state,spgrid,tgrid,Tpause,record,zlims)
% function [MovAnim,zlims] = LinSysAnimate1D(state,spgrid,tgrid,BCtype,Tpause,record,zlims)
%
% Plot the solution a 1D partial differential equation (heat or wave)
